  ...
  return (
    <motion.section
      ...
      <motion.div
        ...
        <motion.h1
          className="text-hero-content font-serif text-4xl md:text-6xl lg:text-7xl mb-6"
        ...
        <motion.p
          className="text-hero-content/90 text-lg font-thin md:text-xl max-w-2xl mx-auto mb-10"
          variants={itemVariants}>
